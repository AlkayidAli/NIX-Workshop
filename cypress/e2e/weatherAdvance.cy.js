...
describe('Note page basic', () => {
  ...
  it('Verify day switcher', () => {
    weatherPage.weatherDetailsAdvance.verifyDaySwitcher();

    weatherPage.search.typeLocation('Kharkiv');
    weatherPage.weatherDetails.verifyLocation('Kharkiv, Ukraine');
    weatherPage.weatherDetailsAdvance.clickOnTheFourteenDays();
    weatherPage.weatherDetails.verifyMainWeatherDetails('Kharkiv', 14, 0);
    weatherPage.weatherDetails.verifyForecastForCity('Kharkiv', 14);

    weatherPage.search.typeLocation('Budapest');
    weatherPage.weatherDetails.verifyLocation('Budapest, Hungary');
    weatherPage.weatherDetailsAdvance.clickOnTheSevenDays();
    weatherPage.weatherDetails.verifyMainWeatherDetails('Budapest', 7, 0);
    weatherPage.weatherDetails.verifyForecastForCity('Budapest');
  });

  it('Verify temperature fahrenheit switcher', () => {
    weatherPage.weatherDetailsAdvance.clickOnTheToggleFahr();
    weatherPage.weatherDetails.verifyMainWeatherDetails('Budapest', 7, 0, true);
    weatherPage.weatherDetails.verifyForecastForCity('Budapest', 7, true);
  });

  it('Verify temperature celsius switcher', () => {
    weatherPage.weatherDetailsAdvance.clickOnTheToggleCel();
    weatherPage.weatherDetails.verifyMainWeatherDetails('Budapest', 7, 0);
    weatherPage.weatherDetails.verifyForecastForCity('Budapest', 7);
  });

  it('Verify wind speed MpH switcher', () => {
    weatherPage.weatherDetailsAdvance.clickOnTheToggleMpH();
    weatherPage.weatherDetails.verifyMainWeatherDetails('Budapest', 7, 0, false, true);
  });

  it('Verify wind speed KmpH switcher', () => {
    weatherPage.weatherDetailsAdvance.clickOnTheToggleKmpH();
    weatherPage.weatherDetails.verifyMainWeatherDetails('Budapest', 7, 0);
  });
});
